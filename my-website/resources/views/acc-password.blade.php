							...
							<div class="col-sm-12 col-lg-11">
								...
								<div class="row my-2 align-items-center">
									...
									<div class="col-sm-12 col-lg-9">
										<input type="password" class="text-dark" name="old_password">
									</div>
								</div>
								...
								<div class="row my-2 align-items-center">
									...
									<div class="col-sm-12 col-lg-9">
										<input type="password" class="text-dark" name="new_password">
									</div>
								</div>
								...
								<div class="row my-2 align-items-center">
									...
									<div class="col-sm-12 col-lg-9">
										<input type="password" class="text-dark" name="confirm_password">
									</div>
								</div>
