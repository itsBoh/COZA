	...
	<header>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="{{ url('shoping-cart') }}" class="label1 rs1" data-label1="hot">Cart</a>
				</li>
				...
				<div class="col-sm-12 col-lg-3 p-5 p-b-40">
					...
					<div class="row my-2 justify-content-center">
						<div class="col-11 my-2">
							<a href="{{ url('./account-profile') }}" style="text-decoration: none;" class="account-active">
							...
							<div class="col-sm-12 col-lg-11">
								...
								<div class="row my-2 align-items-center">
									...
									<div class="col-sm-5 col-lg-3 px-3">
										<input type="radio" style="display: inline;" name="account-gender"> Male
									</div>
									<div class="col-sm-5 col-lg-3 px-3">
										<input type="radio" style="display: inline;" name="account-gender"> Female
									</div>
								</div>
								<div class="row my-2 align-items-center">
									<div class="col-sm-12 col-lg-3">
