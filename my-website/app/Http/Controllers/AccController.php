...
class AccController extends Controller
{
    ...
    public function showTransaction()
    {
        ...
        $id = session('customer')->CUST_ID;
        $customer = DB::select('SELECT * FROM customer WHERE CUST_ID = ?', [$id]);
        $query = "select p.PROD_NAME as name, tp.TRANS_QTY as quantity, tp.TRANS_PRICE as price, t.payment_status as 'pay', date_format(t.TRANS_DATE, '%d-%M-%Y') as `date`
        ...
        return view('transaction', compact('trans', 'results', 'wishlists', 'total', 'customer'));
    }
